...
![Carbon sequestration optimization [@atwood2015].](images/atwood2015.png)
...
- Average harvested biomass contains about 15.8 g C m^-2^ cultivation rope.
...
::: {.column width="50%"}
- Average harvested kelp biomass contains about 15.8 g C m^-2^ cultivation rope [@dolliver2022].
- Wakame harvested C was at most 14.1 g C m^-2^ [@sato2022].
- Mozuku harvested C was 3.7 g C m^-2^ [@sato2022].
